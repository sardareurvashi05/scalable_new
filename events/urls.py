...
from .views import event_list_api, event_by_country_api,home,fetch_trip_details,test_mail

urlpatterns = [
    path('', views.dashboard_view, name='home'),
    path('get_events/', views.get_events, name='get_events'),
    path('create_reminder_api/', views.create_reminder_api, name='create_reminder_api'),
    path('email/', test_mail, name='test_mail'),
    path('fetch_trip_details/', views.fetch_trip_details, name='fetch_trip_details'),
    ...
    path('reminders/', views.reminder_list, name='reminders'),  # Use views.reminder_list
